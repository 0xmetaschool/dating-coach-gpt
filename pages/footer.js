      ...
      <Box maxW="7xl" mx="auto" px="1.25rem" mt="1.25rem" mb="1.25rem">
        <Flex justifyContent="space-between" alignItems="flex-start">
          ...
          <Box textAlign="center">
            ...
            <Text color="black" mb="4" fontSize="2xl" fontWeight="bold" fontFamily="sans-serif">
              Build your own Dating Coach GPT
            </Text>
            <Flex alignItems="center" gap="4">
              ...
              <Box position="relative" display="inline-flex" alignItems="center" className="group">
                <Button
                  leftIcon={
                    <svg viewBox="0 0 16 16" width="16" height="16" className="fill-current" fill="currentColor">
                ...
                <Box position="relative" w="20" h="8">
          ...
          <Flex flexDirection="column" alignItems="flex-end" gap="4">
            ...
            {/* Social links */}
            <Flex alignItems="center">
              <Text mr="4" color="gray.600" pt="4" fontFamily="sans-serif">Follow us on</Text>
              <Flex alignItems="center" gap="3" pt="4">
                <Link href="https://discord.com/invite/vbVMUwXWgc" isExternal>
                ...
                <Link href="https://twitter.com/0xmetaschool" isExternal>
